...
| Vision | iOS 18+ / iOS 26+ | [reference/vision.md](reference/vision.md) | Vision, ImageRequestHandler, DetectFaceRectanglesRequest, DetectFaceLandmarksRequest, DetectHumanBodyPoseRequest, DetectHumanHandPoseRequest, DetectHumanBodyPose3DRequest, RecognizeTextRequest, DetectBarcodesRequest, ClassifyImageRequest, GeneratePersonSegmentationRequest, GenerateForegroundInstanceMaskRequest, GenerateOpticalFlowRequest, CalculateImageAestheticsScoresRequest, RecognizeDocumentsRequest, DetectLensSmudgeRequest, CoreMLRequest, async/await Vision, Swift Vision API |
